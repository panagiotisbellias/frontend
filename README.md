...
Since creating this project, I became aware of Pixelfed @ https://pixelfed.org and Lipupini @ https://github.com/lipupini/lipupini ! It's a promising effort to solve the problem of Instagram for people on Earth and hopefully also Metagram. I would figure that if you come to this repository you might be looking for similar solutions, so here is one :) There has not been a whole lot of activity on this Instalution project, but I'd be happy if someone expressed support for continued efforts on this as well.
